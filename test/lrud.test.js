...
describe('LRUD spatial', () => {
  ...
  //     await page.goto(`file://${__dirname}/layouts/1c-4f.html`);
  ...
  //   it('should focus on the third item on a down arrow press', async () => {
  //     await page.goto(`file://${__dirname}/layouts/2c-v-4f.html`);
  //     await page.waitForSelector('.loaded');
  //     await page.keyboard.press('ArrowDown');
  ...
  //   it('should focus on the first item on a down, up arrow press', async () => {
  //     await page.goto(`file://${__dirname}/layouts/2c-v-4f-no-ids.html`);
  //     await page.waitForSelector('.loaded');
  //     await page.keyboard.press('ArrowDown');
  //     await page.keyboard.press('ArrowUp');
  ...
  //     await page.goto(`file://${__dirname}/layouts/2c-h-4f.html`);
  //     await page.waitForSelector('.loaded');
  //     await page.keyboard.press('ArrowDown');
  ...
  //     await page.goto(`file://${__dirname}/layouts/0c-v-11f-size.html`);
  //     await page.waitForSelector('.loaded');
  //     await page.keyboard.press('ArrowRight');
  //     await page.keyboard.press('ArrowDown');
  ...
  describe('Page with 3 candidates with equal distances to matching corners', () => {
    it('should focus on candidate 1 when down, right, up is pressed', async () => {
      await page.goto(`http://localhost:3005/test/layouts/0c-3f-distance.html`);
