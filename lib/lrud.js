 ...
 *
 * @param {Element} initialContainer The container to start from
 * @return {Element[]} An array of ancestor containers
 */
 ...
 *
 * @param {Element} container Current focus container
 * @param {Element} candidateContainer Candidate focus container
...
export const getNextFocus = (elem, keyCode) => {
  ...
  if (bestCandidate) {
    ...
    if (!isCurrentContainer && !isNestedContainer) {
